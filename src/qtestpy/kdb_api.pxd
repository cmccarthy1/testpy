...
cdef extern from 'k.h' nogil:
    ...
    cdef K kg(I x)
    cdef K kh(I x)
    cdef I khp(const S hostname, I port)
    cdef I khpu(const S hostname, I port, const S credentials)
    cdef I khpun(const S hostname, I port, const S credentials, I timeout)
    cdef I khpunc(S hostname, I port, S credentials, I timeout, I capability)
    cdef V kclose(I x)
    cdef K ki(I x)
    cdef K kj(J x)
    cdef K knk(I n, ...)
